				...
				<form action="useraction.php" method="post">
					<div class="row">
                        ...
                        <div class="col-md-6 col-12">
							...
							<select name="category_id" id="category_id" class="form-control" onchange="subcategory()">
						...
						<div class="col-md-6 col-12">
							...
							<input type="number" id="user" name="phone" value="" required>
						</div>
						<div class="col-md-6 col-12">
							<label for="fname">Email:</label><br>
							<input type="email" id="user" name="email" value="" required>
						</div>
							
						<div class="col-md-6 col-12">
							<label for="fname">Qualification:</label><br>
							<input type="text" id="user" name="qualification" value="" required>
						</div>
						<div  class="col-md-6 col-12">
						<label for="fname">Address:</label><br>
							<input type="text" id="user" name="address" value="" required>
						</div>
