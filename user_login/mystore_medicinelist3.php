             ...
             $stock=$result['stock'];
              ...
              <td>£<?php echo $result['price'];?></td>
                 <td><?php echo $result['expiry']; ?></td>
			       ...
			       <!-- <button type="button"class="btn btn-danger btn-rounded btn-sm my-0 deletebtn" id="buttonids_<?php echo $transid;?>" dataid="<?php echo $transid;?>"><i class="far fa-trash-alt"></i></button></span> -->
