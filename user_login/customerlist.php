...
<div class="col-md-12 col-12 dash-text">
 ...
 $db1  =   new Database();
  ...
  //               $stmt=$db2->query("SELECT * FROM `shop_details` where `id`='$shop_id' order by `id` desc");    
  ...
  // {
			           ...
			           <tr>
			           <td ><?php echo $i;?> </td>
			            <!-- <td><?php echo "CTR";?><?php echo $j;?></td> -->
			          <td><?php echo $result['id'];?></td>
                <td><?php echo $result['dob']; ?> <?php echo $result['firstname']; ?> </td>
                
                
                 <td><?php echo $result['housenumber']; ?></td>
                 <td><?php echo $result['street']; ?></td>
                 <td><?php echo $result['postcode']; ?></td>
                 <td><?php echo $result['city']; ?></td>
                 <td><?php echo $result['country'];?></td>

                 <td><?php echo $result['country1']; ?></td>
