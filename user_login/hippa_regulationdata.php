                             ...
                             foreach($rows1 as $result)

                                 {
                                    ?>
                                        ...
                                        <td><?php echo $result['Incident Type'];?></td>
								<td><?php echo $result['description'];?></td>
							<td><?php echo $result['resolution'];?></td>
               <td><a href="editCustomerEntry.php?transaction=<?php echo base64_encode($value['id']);?>"><button type="button" class="btn btn-success btn-rounded btn-sm my-0"><i class="fa fa-pencil-square" aria-hidden="true">Edit</i></button></a></td>                           
