			...
			<div class="card" style="width: 100%;">
			  ...
			  <table id="example" class="table-bordered display">
			      <!-- <table class="table table-xs-responsive table-hover" aria-role="table"> -->
			        ...
			        <?php $i=1;
			        $cid=$_GET['id'];
			     //  echo "SELECT * FROM `checkout_salesdetails` WHERE `Customer_id`='$cid'";
...
<!-- 
                              <?php 
                                  $db2= new  Database();
                                  $stmt=$db2->query("SELECT * FROM `drug_detail` where `id`='$drugid'");    
                                   $rows2 = $db2->resultset();
 ...
 -->
                                         ...
                                         <td><?php echo $result2['Drug_name']; ?></td>
       ...
       <form action="finalsalesmanagement.php" method="post">
