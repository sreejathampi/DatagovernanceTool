...
<div class="col-md-12 col-12 dash-text">
 ...
 $db1  =   new Database();
                ...
                $stmt=$db1->query("SELECT * FROM `drug_details`");    
...

  {
             ...
             $currentstock=$result['stoke'];
                ...
                <?php if($currentstock<=5){?>
                	<td bgcolor="red";><?php echo $result['stoke']; ?></td>
                <?php } else { ?>
                <td><?php echo $result['stoke']; ?></td>
              <?php } ?>
              <td>£<?php echo $result['sales_figure'];?></td>
