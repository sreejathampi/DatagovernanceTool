  ...
  <?php if (empty($_SESSION['registerId'])) 
    ...
    <script type="text/javascript" src= "https://cdn.datatables.net/1.10.22/js/jquery.dataTables.min.js"> </script> 
                         ...
                         <div class="project-head">
                             <h4><center>User Department</center></h4>
                      
                       </div>
                      <center><a class="btn btn-primary" href="newusercategory.php">Add New User Role</a></center> 
    ...
    <table id="tableID" class="display" style="width:80%"> 
        ...
        <tbody> 
                        <?php $i=1;
                             $dbnew= new Database(); 
                            $stmt=$dbnew->query("SELECT * FROM `usercategory`");    
