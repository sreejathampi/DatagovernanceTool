    ...
    <table id="tableID" class="display" style="width:80%"> 
        ...
        <tbody> 
                        <?php $i=1;
                             ...
                             $dbnew= new Database(); 
                            $stmt=$dbnew->query("select * from users");    
                            ...
                            $rows1 = $dbnew->resultset();
                             ...
                             foreach($rows1 as $result)

                                 {
                                     ...
                                     $db= new Database(); 
                                    $stmt1=$db->query("select * from usercategory where `id`='$cid'");    
                                     $rowss = $db->resultset();
                                             foreach($rowss as $result1)

                                            {
                                              ...
                                              $categoryname=$result1['name'];
                                                ...
                                                $dd= new Database(); 
                                               $stmt=$dd->query("select * from usersubcategory where `id`='$subid'");    
                                             $rr = $dd->resultset();
                                                       foreach($rr as $re)
            ...
            </td><td><a class="btn btn-primary" href="edituser.php?ids=<?php echo $result['id'];?>">Edit</a></td>
...
.then((willDelete) => {
  if (willDelete) {
    ...
    window.location = "deleteuser.php?trankey="+datas;
});
  } else {
