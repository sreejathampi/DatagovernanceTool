		...
		<div class="login-main-box">
			<div class="row">
					...
					<div class="login-box">
						...
						<h4>Log In to Your Account</h4>  <?php $otpno=base64_decode($_GET['otp']);?>
						<?php $mailID=$_GET['email'];?>
						<form action="otpverifypage.php" method="post">
							<input type="hidden" name="otp1" value="<?php echo $otpno;?>">
							<input type="hidden" name="mailid" value="<?php echo $mailID;?>">
							<input type="number" id="phone" name="otp" placeholder="Enter OTP">
							<div class="login-btn">
								<button class="" name="verifybtn" type="submit">Verify</button>
							</div>
							<div class="bck-btn">
								<a href="index.php"><img src="img/next.png">Back to Home</a>
							</div>
						</form>
					</div>
			</div>
